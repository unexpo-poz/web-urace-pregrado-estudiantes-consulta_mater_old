...
$raizDelSitio		= 'http://'.$_SERVER['SERVER_NAME'].'/web/urace/pregrado/estudiantes/consulta_mater_old/';
$urlDelSitio		= 'http://www.poz.unexpo.edu.ve/web/urace';

$lapsoProceso		= '2023-1';
$tLapso				= ' Lapso '.$lapsoProceso;
$laBitacora			= $_SERVER[DOCUMENT_ROOT].'log/pregrado/estudiantes/consulta_mater/cons_planillas_old_'.$lapsoProceso.'.log';
$inscHabilitada		= true;
