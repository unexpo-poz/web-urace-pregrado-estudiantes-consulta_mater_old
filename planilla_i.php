...
<head>
		...
		<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
				<title>Planilla de Inscripci&oacute;n <?php= $tLapso ?></title>
        ...
        <body <?php=$botonDerecho;?> onload="javascript:self.focus();" onclose="return false" >
    ...
    <tr>
        ...
        Planilla de Inscripci&oacute;n  <?php=$tLapso ?></p></td>
    </tr>    <tr><td width="750">
        <table align="center" border="0" cellpadding="0" cellspacing="1" width="550">
            <tr><td class="dp">&nbsp;</td><tr> 
            <tr><td class="dp" style="text-align: right;"> 
Fecha:&nbsp; <?php echo $fecha  = date('d/m/Y', time() - 3600*date('I'))?>&nbsp;&nbsp;Hora: &nbsp; <? echo $hora   = date('h:i:s A', time() - 3600*date('I'))?> </td></tr>   
            <tr><td class="dp">&nbsp;</td><tr> 
 	   </table>
    ...
    <td width="750">
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="1" width="550">
			...
			<?php	
				...
				$mSQL = $mSQL."a.c_asigna=b.c_asigna and exp_e='$dp[3]' and status in(7,'A',2,'P')";
       ...
       <tr><td width="750">
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="1" width="550">
			...
			<?php
				...
				$mSQL = $mSQL."from dace006 a, tblaca008 b ";
				$mSQL = $mSQL."where lapso='$lapsoProceso' and ";
				$mSQL = $mSQL."a.c_asigna=b.c_asigna and exp_e='$dp[3]' and status='Y'";
				$Cmat->ExecSQL($mSQL,__LINE__,true);
				$datosm = $Cmat->result;
        ...
        <TR><TD>
			...
			<?php	
				...
				if($Cdep->filas == '0'){
						print "<tr>";
						print "<td nowrap=\"nowrap\" bgcolor=\"#FFFFFF\" colspan='6'>";
						print "<div class=\"mat2\">NO TIENES MATERIAS INSCRITAS NI AGREGADAS ACTUALMENTE, SI REALIZASTE AGREGADO DE MATERIAS<BR> ES POSIBLE QUE A&Uacute;N EST&Eacute;N EN PROCESO.<BR><BR> DIR&Iacute;GETE A URACE PARA VERIFICAR TU ESTATUS.</div></td>";
						print "</tr>";
					}
				$total=0;
            ...
            */?>			
            ...
            <td class="depo" style="text-align: right;"><?=$total?>.00</td> 
            </tr>
        </tr>
        </table> 
        </TD></TR></TABLE></td></tr> -->
